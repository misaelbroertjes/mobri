    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                <div className="absolute top-0 right-0 w-2/3 h-2/3 bg-gradient-to-br from-primary/10 to-transparent rounded-bl-full blur-3xl opacity-50" />
            ...
            <div className="container mx-auto px-4 md:px-6 z-10 grid md:grid-cols-2 gap-12 items-center">
                ...
                >
                    {/* Solid Card Design - Stronger visual presence */}
                    <div className="relative z-10 bg-secondary text-secondary-foreground p-8 rounded-3xl shadow-2xl max-w-md ml-auto border-4 border-primary/20">
                        ...
                        {/* Conversation Bubbles - Solid Colors */}
                    ...
                    {/* Decorative Solid Elements - No Blur */}
                    <div className="absolute -top-6 -right-6 w-24 h-24 bg-primary rounded-full opacity-20" />
                    <div className="absolute bottom-[-20px] -left-10 w-40 h-40 bg-secondary/10 rounded-full" />
                    {/* Connection line graphic */}
                    <svg className="absolute top-1/2 -left-12 w-24 h-24 text-primary/30 z-0" viewBox="0 0 100 100">
